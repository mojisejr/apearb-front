      ...
      <div className="flex items-center gap-10">
        ...
        <div className="max-w-[500px]">
          ...
          <p className="text-[20px]">
            Pepekub feels sorry for all the Kubers who have never returned to
            their original place since Punkkub collapsed. It is time for all the
            Kubbers to wake up again with the power of the world of memes.
          </p>
          <p className="text-[20px] mt-10">
            Pepekub is the hope of quality memes. We are not just memes. We
